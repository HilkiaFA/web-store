...
<body>
	<header>
		<h1 style="color:white; float: left; margin-left: 50px; margin-top: 30px;">Nama Makanan</h1>
		<div>
		...
		<div class="navbar">
			<ul>
				...
				<li><a style="color:white" href="#">Beli</a></li>
				<li><a style="color:white" href="#">Daftar</a></li>
	...
	<footer>
		<h1 class="txt-judul-footer">Kontak Kami</h1>
		<div class="ass-footer"></div>
		<div class="footer"></div>
		<div class="ass-footbawah"></div>
	</footer>
